...
if [ -z "$GITHUB_TOKEN" ]; then
  ...
  githubUrl=https://lsq4590578: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@github.com/lsq4590578/vuepress-theme-vdoing.git
...
git add -A
git commit -m "${msg}"
git push -f $githubUrl master:lsqiong # 推送到github gh-pages分支
